  ...
  <footer class="bg-gray-800 text-white pt-16 pb-8">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 border-b border-gray-700 pb-8 mb-8">
        ...
        <!-- Organization Info -->
        <div>
          <h4 class="text-xl font-bold mb-4 text-green-400">Jagoroni Mohila Foundation</h4>
          <p class="text-sm text-gray-400 leading-relaxed">
            This institution is making every effort to build an ideal welfare society in the service of humanity, 
            following in the footsteps of the great Prophet Muhammad, the teacher of humanity, the messenger of 
            human liberation and peace.
          </p>
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li>
              <Link :href="route('activities')" class="hover:text-green-400 transition duration-150 flex items-center">
                <svg class="w-3 h-3 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                Activities
            ...
            <li>
              <Link :href="route('blog')" class="hover:text-green-400 transition duration-150 flex items-center">
                <svg class="w-3 h-3 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                Blog
        ...
        <div>
          ...
          <ul class="space-y-2 text-gray-400">
            ...
            <li>
              <Link href="/terms" class="hover:text-green-400 transition duration-150 flex items-center">
                <svg class="w-3 h-3 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"/>
                </svg>
                Terms of Service
      ...
      <div class="flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400">
        ...
        <div class="mb-4 sm:mb-0 text-center sm:text-left">
          <p>Copyright © {{ currentYear }} Jagoroni Mohila Foundation - All rights reserved.</p>
          <p class="text-xs mt-1">Registered under Patuakhali Women's Affairs Department (MB.A/Patua 3/91) & Patuakhali District Youth Development Department (JuboA/Patua/545/97)</p>
        </div>
